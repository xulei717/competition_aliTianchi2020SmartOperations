...
features = [x for x in train.columns if x not in ["serial_number", "manufacturer", "model", "dt", "fault_time", "differ_day", "label", 'dt_first','smart_9raw']]
...
for index, (train_idx, val_idx) in enumerate(fold.split(X, y)):
    ...
    joblib.dump(model, path + '/models/model'+cla+'_' + str(val_f1) + '.txt')
...
print(result.shape)  
result[["manufacturer", "model", "serial_number", "dt"]].to_csv(path + "/result/result"+cla+"_8.csv", index=False, header=None)
result = result.groupby(["manufacturer", "model", "serial_number"])["dt"].min().reset_index()
result.to_csv(path + '/result/result'+cla+'_min8.csv', index=False, header=None)
print(result.shape) 
# 11: (89, 5), (89, 5), (8, 4)
# 12: (3416, 5), (3416, 5), (310, 4)
# 13: (15442, 5), (81, 5), (, 4)
# 14: (14164, 5), (195, 5), (, 4)
# 01: (960, 5), (960, 5), (66, 4)
# 02: (23532, 5), (23532, 5), (1907, 4)
# 03: (58286, 5), (55, 5), (, 4)
# 04: (62137, 5), (62137, 5), (4082, 4)
...
# 把8类预测结果进行合并
pre11 = pd.read_csv(path + '/result/result11_auc_min8.csv', names=["manufacturer", "model", "serial_number", "dt"])
pre12 = pd.read_csv(path + '/result/result12_auc_min8.csv', names=["manufacturer", "model", "serial_number", "dt"])
pre13 = pd.read_csv(path + '/result/result13_auc_min8.csv', names=["manufacturer", "model", "serial_number", "dt"])
pre14 = pd.read_csv(path + '/result/result14_auc_min8.csv', names=["manufacturer", "model", "serial_number", "dt"])
pre01 = pd.read_csv(path + '/result/result01_auc_min8.csv', names=["manufacturer", "model", "serial_number", "dt"])
pre02 = pd.read_csv(path + '/result/result02_auc_min8.csv', names=["manufacturer", "model", "serial_number", "dt"])
pre03 = pd.read_csv(path + '/result/result03_auc_min8.csv', names=["manufacturer", "model", "serial_number", "dt"])
pre04 = pd.read_csv(path + '/result/result04_auc_min8.csv', names=["manufacturer", "model", "serial_number", "dt"])
...
pre.to_csv(path + '/result/result8_auc_min.csv', index=False, header=None)
...
rt12 = pd.read_csv(path + '/result/result8_auc_min.csv', names=["manufacturer", "model", "serial_number", "dt"])
...
tr.to_csv(path + '/result/result8_auc_max_test.csv', index=False, header=None)
