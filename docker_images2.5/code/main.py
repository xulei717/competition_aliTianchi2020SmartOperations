...
# data_path = tmp_path + '201807.csv'
# labeling.get_label(tag_path, data_path, '07')
# # 201808
# tag_path = 'data/round2_train/disk_sample_fault_tag_201808.csv'
# data_path = tmp_path + '201808.csv'
# labeling.get_label(tag_path, data_path, '08')

# 筛选出测试集中唯一值特征，并在测试集和训练集中删除这些唯一值特征
year_month = '201809'  # docker中需要换成'201809'
train_files = [tmp_path+x for x in ['201808.csv', '201807.csv']]   # docker中是201807和201808
...
train_list = list()
for f in ['user_data/tmp_data/201808.csv', 'user_data/tmp_data/201807.csv']:  # docker中需要换成'201808'和'201807'
    print(f)
    df = pd.read_csv(f)
